...
func (c *Client) tagsFromMetric(m model.Metric) map[string]string {
...
func (c *Client) Write(samples model.Samples) error {
	level.Info(c.logger).Log("Writing to influx...")
...
func (c *Client) Read(req *prompb.ReadRequest) (*prompb.ReadResponse, error) {
	level.Info(c.logger).Log("Reading from influx...")
